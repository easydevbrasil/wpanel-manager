    ...
    return (
      <div className="flex items-center gap-2">
        <Button
          ...
          className={`h-6 px-2 text-xs ${propagated
...
export default function DNSSimple() {
  ...
  // Carregamento imediato dos registros DNS
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        const res = await apiRequest("GET", "/api/dns/records?per_page=1000");
                ...
                <>
                  ...
                  {hasMore && (
                    <div className="text-center pt-4">
                      <Button onClick={handleLoadMore} disabled={recordsLoading} variant="outline">
